...
public class User  extends BaseTimeEntity{
    ...
    @Builder
    public User(String email, String password, String name, String phoneNumber, String nickname, String birth, UserRole role, String profileImageUrl, String location){
        this.email = email;
